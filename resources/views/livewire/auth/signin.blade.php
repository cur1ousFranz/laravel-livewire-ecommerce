...
<section>
    <div class="flex flex-col-reverse mx-auto text-center space-x-6 py-6 items-center w-10/12 lg:flex-row lg:justify-center">
        ...
        <div class="flex justify-center w-full lg:w-1/2">
            <div class="space-y-3 w-8/12 border-blue-200 rounded-xl bg-gray-100 px-8 py-6">
                ...
                <form class="py-4 space-y-4" wire:submit.prevent="index">
